            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input required class="input--style-3" type="text" placeholder="Full name" name="fullname">
                        </div>
                        ...
                        <div class="input-group">
                            <input required class="input--style-3" type="password" placeholder="Confirm password" name="passCon">
                        </div>

                        <div class="input-group">
                            <label for="profilePic">Choose profile photo</label>
                            <input required class="input--style-3 file-input" type="file" name="profilePic">
                        </div>
